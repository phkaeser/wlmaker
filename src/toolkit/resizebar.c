    ...
    const wlmtk_resizebar_style_t *style_ptr)
{
    ...
    resizebar_ptr->left_button_ptr = wlmtk_resizebar_button_create();
    ...
    unsigned width)
{
    ...
    if (!wlmtk_resizebar_button_redraw(
            resizebar_ptr->right_button_ptr,
            resizebar_ptr->gfxbuf_ptr,
